                    ...
                    <form class="row" action="">
                        ...
                        <div class="form-group col-md-3 col-sm-3">
                            ...
                            <div class="input-append date" id="dp1">
                                <input class="form-control formDatePicker" name="from_date"  placeholder="From date" size="44" type="text" required>
                        ...
                        <div class="form-group col-md-3 col-sm-3">
                            ...
                            <div class="input-append date" id="dp2">
                                <input class="form-control formDatePicker" name="to_date"   placeholder="To date" size="44" type="text" required>
                                <span class="add-on"><i class="fa fa-calendar"></i></span>
