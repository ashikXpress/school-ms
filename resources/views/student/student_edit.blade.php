                    ...
                    <form action="{{route('student.update',$student->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 col-sm-6">
                                ...
                                <input id="dpicker1" readonly class="form-control" name="admission_date" value="{{$student->admission_date}}"  placeholder="Enter date of birth" size="44" type="text"   aria-invalid="false">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 col-sm-6">
                                ...
                                <input id="dpicker2" readonly class="form-control" name="date_of_birth" value="{{$student->date_of_birth}}"  placeholder="Enter date of birth" size="44" type="text" aria-invalid="false">
