    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-box">
                <div class="card-head">
                    <header>Creative Question List</header>
                    <div class="tools">
                ...
                <div class="card-body ">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-6">
                            ...
                            <div class="btn-group">
                                <a href="{{route('create.creative.question.form')}}" id="addRow" class="btn btn-info">
                                    Add Creative Question <i class="fa fa-plus"></i>
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="example4_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle dataTable no-footer" id="example4" role="grid" aria-describedby="example4_info">
                                        ...
                                        @foreach($questions as $question)
                                            <tr class="gradeX odd" role="row">
                                                ...
                                                <td class="left">{{$question->class}}</td>
                                                <td class="left">{{$question->subject}}</td>
                                                <td class="left">{{$question->examination_term}}</td>
                                                <td class="left">{{$question->academic_year}}</td>

                                                {{--                                                <td class="left">{!! Illuminate\Support\Str::words(html_entity_decode($syllabus_list->description),5) !!}</td>--}}


                                                <td>
                                                    <a href="{{route('creative.question.details',$question->id)}}" class="btn btn-default btn-xs">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-5">
                                    <div class="dataTables_info" id="example4_info" role="status" aria-live="polite">Showing {{$question->count()}} of {{$counts}} entries</div>
                                </div>
