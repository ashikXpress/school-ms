                    ...
                    <div class="card-body no-padding height-9">
                        <div class="row">
                            <div class="profile-userpic">
                                <img src="{{asset($employee_profile->photo)}}" class="img-responsive" alt="">
                            </div>
                        </div>
                        <div class="profile-usertitle">
                            <div class="profile-usertitle-name">{{$employee_profile->first_name.' '.$employee_profile->last_name}}</div>
                        </div>
