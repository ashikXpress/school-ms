    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="card card-box">
                <div class="card-head">
                    <header>Employee Payment Update</header>
                </div>
                <div class="card-body " id="bar-parent2">
                    <form action="{{route('employee.payment.update',$payment->id)}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label for="class">Employee name</label>
                                <select class="form-control" name="employee_name" id="class">
                                    <option  value="{{$payment->employee_id}}" selected>{{$payment->employee->first_name.' '.$payment->employee->last_name}}</option>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input id="dpicker1" value="{{$payment->payment_date}}" readonly class="form-control" name="payment_date"  placeholder="Enter payment date" size="44" type="text" >
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" id="receipt_no" value="{{$payment->receipt_no}}" class="form-control" name="receipt_no"  placeholder="Enter receipt no" >
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" id="basic_salary" value="{{$payment->basic_salary}}" class="form-control" name="basic_salary"  placeholder="Enter basic salary" >
                                <span class="text text-danger">{{$errors->first('basic_salary')}}</span>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="others_honorarium">Others honorarium</label>

                                <input type="number" id="others_honorarium" value="{{$payment->others_honorarium}}" class="form-control" name="others_honorarium"  placeholder="Enter others honorarium" >
                            ...
                            <div class="form-group col-md-12">
                                <div class="col-md-9">
                                    <button type="submit" class="btn btn-info btn-lg m-r-20">Update Payment</button>
