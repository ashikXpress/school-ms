                                ...
                                <div class="col-sm-12">
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle dataTable no-footer" id="example4" role="grid" aria-describedby="example4_info">
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example4" rowspan="1" colspan="1" aria-label=" Name : activate to sort column ascending" style="width: 85px;">Shift name</th>
                                        ...
                                        @foreach($shift_lists as $shift_list)
                                            <tr class="gradeX odd" role="row">
                                                <td class="left">{{$shift_list->id}}</td>
                                                <td>{{$shift_list->shift_name}}</td>
                                                <td class="left">Admin</td>
                                                <td>{{$shift_list->created_at}}</td>
                                                <td>{{$shift_list->updated_at}}</td>
                                                <td class="left">{{$shift_list->description}}</td>
                                                <td>
