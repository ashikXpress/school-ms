                    ...
                    <form action="{{route('update.class',$class->id)}}" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-8 col-sm-8">
                                ...
                                <input type="text" name="class_name" value="{{$class->class_name}}" id="class_name" class="form-control" placeholder="Enter class name">
                            ...
                            <div class="form-group col-md-8 col-sm-8">
                                ...
                                <textarea class="form-control" name="description" value="{{$class->description}}" id="description" rows="3" placeholder="Enter description"></textarea>
