...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-box">
                <div class="card-head">
                    <header>All designation list</header>
                    <div class="tools">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle dataTable no-footer" id="example4" role="grid" aria-describedby="example4_info">
                                        ...
                                        @foreach($designation_lists as $designation_list)
                                            <tr class="gradeX odd" role="row">
                                                <td class="left">{{$designation_list->id}}</td>
                                                <td>{{$designation_list->designation_name}}</td>
                                                <td class="left">Admin</td>
                                                <td>{{$designation_list->created_at}}</td>
                                                <td>{{$designation_list->updated_at}}</td>
                                                <td class="left">{{$designation_list->description}}</td>
                                                <td>
