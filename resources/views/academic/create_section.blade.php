...
@section('content')
                    ...
                    <form action="{{route('create.section')}}" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-8 col-sm-8">
                                ...
                                <input type="text" name="section_name" value="{{old('section_name')}}" id="section_name" class="form-control" placeholder="Enter section name">
                            ...
                            <div class="form-group col-md-12">
                                <div class="col-md-9">
                                    <button type="submit" class="btn btn-info btn-lg m-r-20">Create section</button>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-box">
                <div class="card-head">
                    <header>All Section list</header>
                    <div class="tools">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle dataTable no-footer" id="example4" role="grid" aria-describedby="example4_info">
                                        ...
                                        @foreach($section_lists as $section_list)
                                            <tr class="gradeX odd" role="row">
                                                <td class="left">{{$section_list->id}}</td>
                                                <td>{{$section_list->section_name}}</td>
                                                <td class="left">Admin</td>
                                                <td>{{$section_list->created_at}}</td>
                                                <td>{{$section_list->updated_at}}</td>
                                                <td class="left">{{$section_list->description}}</td>
                                                <td>
